{
	"date":{
		...
		"中考": {
			...
			"end": new Date(2021,6,16,8,0,0,0),
			"color": "#59c",
			"background-color": "#a63"
		},
		"高考": {
			"start": new Date(2024,6,1,8,0,0,0),
			"end": new Date(2024,6,6,8,0,0,0),
			"color": "#59c",
			"background-color": "#a63"
		},
		"desk-good死亡": {
	...
	"color": 12,
	"message": "No,即将马上就要考期末考试了！然后就放暑假了！再然后……就是九年级毕业班了，然后马上就要中考了！！！\nAnd桌子好又双叒叕要跑1500光年了！怎么办，凉拌炒鸡蛋，不好吃也不好看，放点砒霜，吃了就上天堂……"
}
