{
	"date":{
		...
		"<b style='color:red;'>线上考试*3！！！</b>": {
			"start": new Date(2020,3,13,19,0,0,0),
			"end": new Date(2020,3,18,21,10,0,0),
			"color": "#4D99FF",
			"background-color": "#a63"
		},
		...
		"体育节（九）": {
			"start": new Date(2020,9,28,9,0,0,0),
			"end": new Date(2020,9,30,17,0,0,0),
			"color": "#0f0",
			"background-color": "#f00"
		},
		"期中考试": {
			"start": new Date(2021,11,11,8,10,0,0),
		...
		"中考": {
			...
			"end": new Date(2021,5,19,12,0,0,0),
			"color": "#4D99FF",
			"background-color": "#a63"
		},
		"高考": {
			"start": new Date(2024,5,4,8,0,0,0),
			"end": new Date(2024,5,6,12,0,0,0),
			"color": "#4D99FF",
			"background-color": "#a63"
		},
		"desk-good死亡": {
	...
	"color": 17,
	"message": `即将体育节了,deskgood终于可以跑1500了！Oh No,只有${(new Date(2020,11,11,8,10)-new Date)/1000/3600/24}天期中考试了！然后马上只有${(new Date(2021,5,17,8)-new Date)/1000/3600/24}天就要中考了！！！\nAnd桌子好又双叒叕要跑1500光年+下雨天看树和草了！怎么办，凉拌炒鸡蛋，不好吃也不好看，放点砒霜，吃了就上天堂……`
}
